<?php
    $url = "asset/json/non-fiction-bestsellers.json";    
...
<div class="row no-gutters padding-content d-flex justify-content-center">
    ...
    <h2 id="title">Non-Fiction: Bestsellers</h2>
        <div class="row align-self-start mt-4">
            ...
            for ($i=0; $i<count($result); $i++){
                ...
                if ($i < 2){
                    echo "<a href='pages/".$result[$i]->key.".php'> <img class=\"card-img-top img-fluid ml-auto mr-auto mb-3\" src=\"images/cover/non-fiction-bestsellers/".$result[$i]->img."\"></a>";
                }else{
                    echo "<a href=''> <img class=\"card-img-top img-fluid ml-auto mr-auto mb-3\" src=\"images/cover/non-fiction-bestsellers/".$result[$i]->img."\"></a>";
                }
