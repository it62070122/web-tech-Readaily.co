                ...
                <div class="container p-0">
                    <div class="row align-self-start mt-4">
                        ...
                        <div class="col-md-5 col-12" id="img1">
                            <img src="../images/cover/new-arrivals-non-fiction/<?php echo $result[0]->img; ?>">
                        </div>
                        <!-- book detail -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row" id="img2">
                                        <img class="pt-5 pb-2" src="../images/cover/new-arrivals-non-fiction/<?php echo $result[0]->img; ?>">
                                    </div>
