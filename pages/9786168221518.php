                ...
                <div class="container p-0">
                    <div class="row align-self-start mt-4">
                        ...
                        <div class="col-md-5 col-12" id="img1">
                            <img src="../images/cover/non-fiction-bestsellers/<?php echo $result[0]->img; ?>">
                        </div>
                        <!-- book detail -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="row" id="name">
                                            ...
                                            <?php 
                                                if($result[0]->thainame != null){
                                                    echo "<h1 class='title-book'>".$result[0]->thainame."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</h1>";
                                                }
                                            ?>
                                            <div class="row no-gutters">
                                                <div class="col-12 ">
                                                    <?php
                                                        ...
                                                        echo '
                                                        <h4><b>ซีรี่ส์: <span style="color:#E54343">'.$result[0]->tag[1].'</span></b></h4>';
                                                        } ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" id="img2">
                                        <img class="pt-5 pb-2" src="../images/cover/non-fiction-bestsellers/<?php echo $result[0]->img; ?>">
                                    </div>
