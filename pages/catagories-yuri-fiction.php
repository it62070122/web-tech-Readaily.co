<?php
    $url = "../asset/json/new-arrivals-fiction.json";    
...
<body>
    ...
    <div class="row no-gutters padding-content d-flex justify-content-center">
        <div class="container p-0">
            <h1 id="title" style="font-size: 2.75em">นิยายยูริ</h1>
            <?php for ($j=0; $j<1; $j++){ 
            echo '<div class="row align-self-start mt-4">';
                for ($i=0; $i<count($result); $i++){
                    ...
                    if ($i < 2){
                        echo "<a href='pages/".$result[$i]->key.".php'> <img class=\"card-img-top img-fluid ml-auto mr-auto mb-3\" src=\"../images/cover/new-arrivals-fiction/".$result[$i]->img."\"></a>";
                    }else{
                        echo "<a href=''> <img class=\"card-img-top img-fluid ml-auto mr-auto mb-3\" src=\"../images/cover/new-arrivals-fiction/".$result[$i]->img."\"></a>";
                    }
