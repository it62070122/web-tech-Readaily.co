...
<head>
    ...
    <title>Memoir & Documentary</title>
        ...
        <div class="container p-0">
            ...
            echo '<div class="row align-self-start mt-4">';
                for ($i=0; $i<count($result); $i++){
                    ...
                    if ($i < 2){
                        echo "<a href='pages/".$result[$i]->key.".php'> <img class=\"card-img-top img-fluid ml-auto mr-auto mb-3\" src=\"../images/cover/mock-memoir/".$result[$i]->img."\"></a>";
                    }else{
                        echo "<a href=''> <img class=\"card-img-top img-fluid ml-auto mr-auto mb-3\" src=\"../images/cover/mock-memoir/".$result[$i]->img."\"></a>";
                    }
